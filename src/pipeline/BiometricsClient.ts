...
// Worker code is injected at compile time by vite-plugin-inline-worker (library build only).
// In dev/demo builds the markers are ignored and Vite handles the worker natively via URL.
